...
class Tentative:
    ...
    """
    def affichageResutat(self,code,tentative,sauvegarde):
        ...
        if self.resultats:
            ...
            self.verifSiVictoire(code,tentative,sauvegarde)
        else:
    ...
    """
    def verifSiVictoire(self,code,tentative,sauvegarde):
